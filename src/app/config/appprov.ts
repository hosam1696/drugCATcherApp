...
export class AppProv {
  ...
  public get countryCallingCode() {
    return this.Countries.map(c=>{return {name:c.name.common,country:c.cca2, callingCode: c.callingCode[0]}})
  }
    ...
    return [
      ...
      },
      {
        ...
        "translations": {
          ...
          "svk": {
            "official": "Republika Pobr\u017eie Slonoviny",
      ...
      },
      {
        ...
        "translations": {
          ...
          "svk": {
            ...
            "common": "K\u00f3rejsk\u00e1 \u013eudovodemokratick\u00e1 republika (K\u013dR, Severn\u00e1 K\u00f3)"
          },
          "fin": {
